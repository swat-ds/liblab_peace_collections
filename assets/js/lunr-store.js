...
---
{% if jekyll.environment == "production" %}{%- assign items = site.data.artifacts | concat: site.data.crabtree_archives | where_exp: 'item','item.objectid and item.parentid == nil' -%}{% else %}{%- assign items = site.data[site.metadata] | where_exp: 'item','item.objectid and item.parentid == nil' -%}{% endif %}
